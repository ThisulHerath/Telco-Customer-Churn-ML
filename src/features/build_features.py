...
def _map_binary_series(s: pd.Series) -> pd.Series:
    ...
    categorical features with exactly 2 values into 0/1 integers. The mapping
...
def build_features(df: pd.DataFrame, target_col: str ="Churn") -> pd.DataFrame:
    ...
    new_features = df.shape[1] - original_shape[1] + len(multi_cols)  # new features added by get_dummies
